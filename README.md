...
For help with editing sections of the OJS interface for the journal there are a series of youtube videos online as well as prose to lead you through the processes. They may be found here: https://docs.pkp.sfu.ca/learning-ojs/en/editorial-workflow

### Files for viewing
Links to live files (at present **six articles in HTML** versions) for the first volume of Pylon can be found in the folder: [pylon1ready](https://github.com/jcowey/P3/blob/master/pylon/pylon1ready/list.md)
