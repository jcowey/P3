...
Fill that in:
Submission Language; Section (Articles / Notes); Title; Type (Text); Languages (en  remember to hit the return key to secure the entry); Keywords; List of contributors
